...
| `minPower` | `minimumPowerOutput` | The minimum power output of the device in Watts (numeric). |
| `maxPower` | `maximumPowerOutput` | The maximum power output of the device in Watts (numeric). |
...
| `p1` | `channel1Power` | The current power of channel 1 in Watts. |
| `e1` | `channel1EnergyToday` | The energy generated by channel 1 today in kWh. |
| `te1` | `channel1EnergyLifetime` | The total energy generated by channel 1 in kWh. |
| `p2` | `channel2Power` | The current power of channel 2 in Watts. |
| `e2` | `channel2EnergyToday` | The energy generated by channel 2 today in kWh. |
| `te2` | `channel2EnergyLifetime` | The total energy generated by channel 2 in kWh. |
