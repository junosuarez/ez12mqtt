...
| `minimumPowerOutput` | `number` | The minimum power output of the device in Watts. |
| `maximumPowerOutput` | `number` | The maximum power output of the device in Watts. |
...
| `channel1Power` | `number | null` | The current power of channel 1 in Watts. `null` if not available. |
| `channel1EnergyToday` | `number | null` | The energy generated by channel 1 today in kWh. `null` if not available. |
| `channel1EnergyLifetime` | `number | null` | The total energy generated by channel 1 in kWh. `null` if not available. |
| `channel2Power` | `number | null` | The current power of channel 2 in Watts. `null` if not available. |
| `channel2EnergyToday` | `number | null` | The energy generated by channel 2 today in kWh. `null` if not available. |
| `channel2EnergyLifetime` | `number | null` | The total energy generated by channel 2 in kWh. `null` if not available. |
